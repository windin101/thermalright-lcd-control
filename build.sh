...
cp -r build/thermalright-lcd-control-*/usr . 2>/dev/null || true
cp -r build/thermalright-lcd-control-*/thermalright_lcd_control . 2>/dev/null || true
...
rm -rf ./thermalright_lcd_control 2>/dev/null || true
